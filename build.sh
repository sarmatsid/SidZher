...
# В БД создаем БД register-db -> в ней таблицу users -> в ней 3 строки: id (int, поставить галочку под A_I), login (var, длина 100), pass (var, длина 1000)